...
export const meta: MetaFunction = () => {
	return [{ title: 'app-template-react' }, { name: 'description', content: 'Welcome to app-template-react' }];
};
...
export default function Index() {
	...
	return (
		<div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-gray-700 via-gray-900 to-black">
			<h1 className="text-4xl text-white font-bold mb-8">Welcome to app-template-react</h1>
